...
BOOST_AUTO_TEST_CASE(test_FormatSubVersion)
{
    ...
    BOOST_CHECK_EQUAL(SanitizeString(std::string("Zcents:2.1.1-1")), "Zcents:2.1.11");
    // fixed by adding new rule https://github.com/zcash/zcash/pull/4444
    BOOST_CHECK_EQUAL(SanitizeString(std::string("Zcents:2.1.1-1"), SAFE_CHARS_SUBVERSION), "Zcents:2.1.1-1");
}
