...
#if defined(NDEBUG)
# error "Zcents cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Zcents Signed Message:\n";
    ...
    bool fCheckTransactions)
{
    ...
    // Founders' Reward and associated funding streams have been disabled, so there are no
    // additional consensus checks to perform here.
